...
verified archive recorded in `resources/dev/audit.md`.
...
controller CLI through the `green-ink` entry point. The repository additionally
contains three dependency-locked Worker sources. `ospo-db` is the recommended
