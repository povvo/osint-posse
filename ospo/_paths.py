...
def release_resources() -> ReleaseResources:
    ...
    source = ReleaseResources(
        skill=_SOURCE_ROOT / "src" / "skills" / "recon-rodeo",
        claude_agents=_SOURCE_ROOT / "src" / ".claude" / "agents",
        codex_agents=_SOURCE_ROOT / "src" / ".codex" / "agents",
    )
