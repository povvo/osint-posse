...
def install(
    ...
    scope: Annotated[str, typer.Option("--scope", callback=_scope, help="Install to project or user scope.")] = "project",
    root: Annotated[Optional[Path], typer.Option("--root", help="Explicit scope root.")] = None,
