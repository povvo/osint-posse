...
CHECKS=['identity','address_history','work_history','education','professional_register','reference_review','media_review','conflict_review','final_review']
...
def main():
    ap=argparse.ArgumentParser(description='Create or audit a structured background review checklist.')
