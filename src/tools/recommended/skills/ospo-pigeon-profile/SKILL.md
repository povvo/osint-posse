...
|---------------|-------------------|----------------------|------------|
| S1 empty or Tier 0–1 | Personality signals in evidence | Big Five / Five-Factor Model | `references/big-five.md` |
| S2 empty or Tier 0–1 | Relational language, proximity-seeking, trust/dependence patterns | Four-Category Attachment Model | `references/attachment-architecture.md` |
| S3 empty or Tier 0–1 | Attribution language in evidence (I made it / I got lucky / they decided) | IPC Scale | `references/locus-of-control.md` |
| S4 empty or Tier 0–1 | Emotional vocabulary, regulation failure episodes, distress response | DERS | `references/emotion-regulation.md` |
| S5 empty or Tier 0–1 | Intellectualisation, projection, splitting, humour deflection visible | Hierarchy of Defences | `references/defence-mechanisms.md` |
| S6 empty or Tier 0–1 | Absolute language, catastrophising, mind-reading in output | CBT Distortion Taxonomy | `references/cognitive-distortions.md` |
| S7 empty or Tier 0–1 | Self-description, worldview language, future orientation | Cognitive Triad | `references/cognitive-triad.md` |
| S8 empty or Tier 0–1 | Meaning language, mortality awareness, isolation/connection themes | Existential Four Givens | `references/existential-orientation.md` |
| S9 violations detected | Contradictions across ≥2 populated sections | Dialectical Poles | `references/contradiction-map.md` |
| S10 empty + S1–S8 at Tier 2+ | Core sections populated enough to synthesise risk | Empirical Risk Synthesis | `references/predictive-risk-map.md` |
| S11 empty or Tier 0–1 | Problem-solving behaviour, self-correction, metacognitive language | CRT + Dual Process Theory | `references/cognitive-processing.md` |
| S12 empty or Tier 0–1 | Default behaviour under uncertainty visible in evidence | Species-Typical Behaviour + Prospect Theory | `references/behavioural-defaults.md` |
| S13 empty or Tier 0–1 | Causal claims without mechanism, rituals, extinction resistance | Superstition + Signal Detection Theory | `references/pigeon-superstition-superposition.md` |
| S14 empty or Tier 0–1 | Conflict descriptions, cooperation/defection patterns, punishment stories | Game Theory / Cooperation Dynamics | `references/interpersonal-strategy.md` |
| S15 empty or Tier 0–1 | Source evaluation behaviour, belief updating, anomaly response | Shortcut Learning / Epistemic Calibration | `references/signal-discrimination.md` |
| S16 empty or Tier 0–1 | Approach/avoidance patterns, risk language, topic engagement vs avoidance | BIS/BAS + Hierarchical Motivation | `references/approach-avoidance.md` |
...
**File:** `references/attachment-architecture.md`
...
**File:** `references/locus-of-control.md`
...
**File:** `references/emotion-regulation.md`
...
**File:** `references/defence-mechanisms.md`
...
#### S7 · Cognitive Triad
**File:** `references/cognitive-triad.md`
**Authors:** Beck, 1967
...
**File:** `references/existential-orientation.md`
...
**File:** `references/contradiction-map.md`
...
**File:** `references/predictive-risk-map.md`
...
**File:** `references/cognitive-processing.md`
...
**File:** `references/behavioural-defaults.md`
...
**File:** `references/pigeon-superstition-superposition.md`
...
**File:** `references/interpersonal-strategy.md`
...
**File:** `references/signal-discrimination.md`
...
**File:** `references/approach-avoidance.md`
