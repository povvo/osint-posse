...
`src/tools/recommended/mcp/ospo-db`, authenticate Wrangler and run `./setup.sh`.
...
configuration. See [`ospo-db/README.md`](ospo-db/README.md) for migration,
backup, authentication, and rollback details.
