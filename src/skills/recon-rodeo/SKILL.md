...
<examples>
  ...
  <example>
    ...
    <o>
      ...
      <task>Run task_runner.py reset, then task_runner.py next to start at t1.1. Call ospo-db:create_investigation with a case name to obtain the investigation_id for all subsequent persistence calls.</task>
