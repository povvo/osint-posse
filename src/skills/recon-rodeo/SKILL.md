...
<examples>
  ...
  <example>
    ...
    <o>
      ...
      <task>Call ospo-db:create_investigation to create the persistent case database record, then run `ospo workflow init INV-meridian` and `ospo workflow next` to start the Green Ink controller CLI at t1.1. Do not reset an existing case.</task>
